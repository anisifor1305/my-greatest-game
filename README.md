...
- После отдельных изменений README в `main` и `docs/readme` был разобран merge conflict: итоговая версия документации собрана вручную, без потери нужных частей из обеих веток.
